...
import bart from '../Imagenes/bart.png'
import pokemon from '../Imagenes/perro.jpeg'
import dona from '../Imagenes/dona.png'
import homero from '../Imagenes/homero.png'
import mario from '../Imagenes/mario.jpeg'
const imagenes = [stich, bart, pokemon, mario, homero, dona]
            ...
            <Slider {...settings}>
                {Tratamientos?.map((item, index) => (
                    <div class={index === slideIndex ? "card card-active" : "card" }>
                        <div class="card-info">
                            <p class="text-title">{item.Titulo} </p>
